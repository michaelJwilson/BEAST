...
int main(int argc, char *argv[]){
  ...
  */
  ...
  double  omega_matter  = atof(argv[1]);
  double  omega_baryon  = atof(argv[2]);
  double  omega_hdm     = atof(argv[3]);
  int     degen_hdm     = atoi(argv[4]);
  double  omega_lambda  = atof(argv[5]);
  double  hubble        = atof(argv[6]); 
  double  redshift      = atof(argv[7]);

  //  Run run.
  TFmdm_set_cosm(omega_matter, omega_baryon, omega_hdm, degen_hdm, omega_lambda, hubble, redshift);
